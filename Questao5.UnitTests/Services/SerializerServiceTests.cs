...
public sealed class SerializerServiceTests
{
    ...
    public void Serialize_ShouldReturnSerializedString()
    {
        ...
        // Assert
        Assert.Equal("{\"Key\":\"3410cda1-5b13-a34e-6f84-a54adf7a0ea0\",\"AccountId\":\"8286d046-9740-a3e4-95cf-ff46699c73c4\",\"Date\":\"2024-02-15\",\"Value\":699.295832169846000,\"Type\":\"C\"}", result);
    }
    ...
    public void Deserialize_ShouldReturnDeserializedObject()
    {
        ...
        Assert.Equal("15/02/2024", result.Date.ToString());
